...
export default function About() {
    return(
        <Container sx={{width: '100%'}}>
            ...
            <Container  sx={{display: 'flex', width: '100%', justifyContent: 'center', margin: 3, marginBottom: 10}}>
                <Box sx={{display: 'flex'}}>
                    <Avatar
                        alt="Inna Romanova"
                        src={InnaRomanova}
                ...
                <Box sx={{display: 'flex', width: '100%', marginLeft: 10, justifyContent: 'left', alignItems: 'center'}}>
                    <Typography variant="h6" align="justify" sx={{display: 'flex', justifyContent: 'center', color: 'grey'}}>
            ...
            <Box sx={{display: 'flex', width: '100%', margin: 3, marginBottom: 5, justifyContent: 'left'}}>
                    <Typography variant="h4" sx={{display: 'flex', justifyContent: 'left', color: 'black'}}> Technique </Typography>
            </Box>


            <Box  sx={{display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'top', margin: 3, marginBottom: 10}}>
                <Typography variant="h6" align="justify" sx={{display: 'flex', width: '100%', justifySelf: 'start', color: 'grey'}}>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
                            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
